...
var MakeService = (function () {
    ...
    MakeService.prototype.saveMake = function (makeData) {
        var headers = new http_1.Headers({ 'Content-Type': 'application/json' });
        var options = new http_1.RequestOptions({ headers: headers });
        var body = JSON.stringify(makeData);
        return this.http.post(this._url, body, { headers: headers }).map(function (res) { return res.json(); });
    };
    return MakeService;
}());
